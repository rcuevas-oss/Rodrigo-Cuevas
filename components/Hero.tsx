        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <FadeIn delay={0}>
            <Badge variant="secondary" className="mb-6 px-3 py-1 font-normal text-muted-foreground border-border hover:bg-secondary">
              ...
              Páginas web, automatización y sistemas a medida
            </Badge>
          </FadeIn>

          <FadeIn delay={100}>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-foreground mb-6 text-balance">
              Soluciones digitales para negocios que ya están creciendo
            </h1>
          </FadeIn>

          <FadeIn delay={200}>
            <p className="text-lg sm:text-xl text-muted-foreground mb-10 leading-relaxed max-w-2xl mx-auto text-balance">
              Creamos páginas web, automatizaciones y software a medida para pymes, emprendedores y negocios que necesitan vender mejor, ordenar procesos y ahorrar tiempo.
            </p>
          </FadeIn>
